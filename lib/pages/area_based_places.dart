...
import 'package:alulatrail/pages/place_details.dart';
...
class AreaBasedPlaces extends StatefulWidget {
  final String? areaName;
  final Color? color;
  AreaBasedPlaces({Key? key, required this.areaName, required this.color}) : super(key: key);

  @override
  _AreaBasedPlacesState createState() => _AreaBasedPlacesState();
}

class _AreaBasedPlacesState extends State<AreaBasedPlaces> {
  ...
  Future<Null> _getData() async {
    ...
    if (_lastVisible == null)
      data = await firestore
          ...
          .where('area', isEqualTo: widget.areaName)
