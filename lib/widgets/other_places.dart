import 'package:alulatrail/blocs/other_places_bloc.dart';
...
class OtherPlaces extends StatefulWidget {
  ...
  OtherPlaces({Key? key, required this.areaName, required this.timestamp})
      : super(key: key);
...
class _OtherPlacesState extends State<OtherPlaces> {
  ...
  void initState() {
    super.initState();
    context.read<OtherPlacesBloc>().getData(widget.areaName, widget.timestamp);
  }
