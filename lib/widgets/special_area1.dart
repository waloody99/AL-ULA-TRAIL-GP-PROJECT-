...
class SpecialAreaOne extends StatelessWidget {
  SpecialAreaOne({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final spb = context.watch<SpecialAreaOneBloc>();
